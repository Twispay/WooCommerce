        ...
        <div class="wrap">
            ...
            <form method="post" id="general_configuration">
                <table class="form-table">
                  ...
                  <tr class="form-field" id="r_custom_unique_identifier">
                    <th scope="row">
                      <label for="unique-identifier-field">
                          <?php echo esc_html($tw_lang['unique_identifier_label']); ?>
                      </label>
                    </th>

                    <td>
                        <?php twispay_tw_get_unique_identifiers_markup(); ?>

                      <p class="description">
                          <?php echo esc_html($tw_lang['unique_identifier_desc']); ?>
                      </p>
                    </td>
                  </tr>
