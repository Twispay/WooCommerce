...
function twispay_tw_install() {
	...
	$wpdb->get_results( $wpdb->prepare( "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "twispay_tw_configuration` (
	...
	$wpdb->get_results( $wpdb->prepare( "CREATE TABLE IF NOT EXISTS `" . $wpdb->prefix . "twispay_tw_transactions` (
